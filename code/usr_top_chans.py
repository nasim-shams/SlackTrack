...
finding usere's top channels, through graph analysis 
@author: shams
"""
import pandas as pd
...
def usr_top_chans(usr, netWindow , nchans = 5):
    ...
    # loading users data and forming the users graph
     ...
     # running HITS analysis on user's graph and returning channels sorted
     # based on HITS score
     try:
